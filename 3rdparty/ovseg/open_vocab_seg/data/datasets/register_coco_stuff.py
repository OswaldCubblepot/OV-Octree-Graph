...
# already registers the identical COCO-stuff datasets. Re-registering raises
# `AssertionError: already registered`. The inference pipeline never loads these
# training datasets, so make registration idempotent.
try:

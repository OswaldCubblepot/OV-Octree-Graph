...
# The Entity mask2former (detector) and this OVSeg fork both register a
# `D2SwinTransformer` in detectron2's shared BACKBONE registry, and detectron2
# asserts on the second registration. This fork's variant is NOT the standard
# detectron2 swin — it adds PROJECTION / PROJECT_DIM for the OVSeg CLIP
# adapter — so it must win: overwrite whatever is already registered.
BACKBONE_REGISTRY._obj_map[D2SwinTransformer.__name__] = D2SwinTransformer
